...
output: word_document #pdf_document #rticles::elsevier_article #  #   #rticles::plos_article
#csl: plos.csl
---
...
`r `![](R:/Mann_Research/IFPRI_Ethiopia_Drought_2016/IFPRI_Ethiopia_Drought_Code/Visualizations/Wheat_Output_bottom40_rm_acd_v2.jpg)
...
`r `![](R:/Mann_Research/IFPRI_Ethiopia_Drought_2016/IFPRI_Ethiopia_Drought_Code/Writeup/ggplot_grey_legend_import.png)
...
#### Panel Regression ----------------------------------------------------
 ...
 # read data
  ...
  # summary(maz.re4)
``` 
*Table `r paste(Table_number)`: Panel RE regression on output per hectare for maize in quintals* `r maize_table=Table_number; Table_number=Table_number+1`
```{r Maize Results, echo=FALSE, message=FALSE, warning=F,results='asis' }
...
```{r Panel Wheat Regression, echo=FALSE, message=FALSE, warning=FALSE,results='asis'}
...
```{r Wheat Results, echo=FALSE, message=FALSE, warning=F,results='asis'}
...
```{r Barley Results, echo=FALSE, message=FALSE, warning=F,results='asis'}
...
```{r Teff Results, echo=FALSE, message=FALSE, warning=F,results='asis'}
...
```{r Sorghum Results, echo=FALSE, message=FALSE, warning=F,results='asis'}
