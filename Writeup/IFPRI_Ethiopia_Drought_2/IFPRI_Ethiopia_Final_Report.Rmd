...
Critically, the AgSS provides us with observations of crop yields and losses for all of Ethiopia's major crops, as well as a snapshot of farmers' practices. Meanwhile, observations from remotely sensed data provides us with a trove of data on rainfall, vegetation properties, and temperature amoungst others. When combined, observations from the AgSS and remotely sensed data provide a powerful combination, coupling observations of farming outcomes with dense observations of properties like plant greeness or the timing of rains. This data fusion allows us to create models that, once trained, can predict corp yeilds and losses solely wiht the use of remotely sensed observations from space or weather stations. 
