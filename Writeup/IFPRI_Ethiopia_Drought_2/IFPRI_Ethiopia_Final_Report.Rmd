...
maz_dam1_w_ea = factor(MAIZEDAMAGEAREA_P< 0.2 ) ~  A_mn + A_min + A_max + A_AUC + A_Qnt + A_sd +  A_max_Qnt +  A_AUC_Qnt  + G_mn  + G_min + G_mx + G_AUC + G_Qnt + G_mx_Qnt + G_AUC_Qnt + G_AUC2 + G_AUC_leading + G_AUC_trailing + G_AUC_diff_mn + G_AUC_diff_90th+T_G_Qnt+G_sd + PET_A_mn + PET_A_min + PET_A_max + PET_A_AUC + PET_A_Qnt + PET_A_sd + PET_G_mn + 
  ...
  # maz.rf<-train(maz_dam1_w_ea,data=pp.train,method="rf",metric="Recall",stratify=T,
  #                 trControl=trainControl(method="oob", seeds=seeds,index = groups), #number iterations+1
  #                 prox=T,allowParallel=T,tuneGrid = expand.grid(mtry=seq(5,15,1)))
  # 
  # save(maz.rf,file = './Outputs4Pred/maz.rf.MAIZEDAMAGEAREA_P_GT.2_zone.RData')
